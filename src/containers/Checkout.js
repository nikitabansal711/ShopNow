        ...
        <React.Fragment>
            ...
            {data.order_items.map((orderItem, i) => {
              return (
                <Item key={i}>
                  <Item.Image
                    size="tiny"
                    src={`https://ecommerce-shopnow.herokuapp.com${orderItem.item.image}`}
                  />
          ...
          <Item.Group>
            <Item>
              <Item.Content>
                <Item.Header>
                  <mark>Order Total: ₹{data.total}</mark>
                  {data.coupon && (
      ...
      <div>
        ...
        {billingAddresses.length < 1 || shippingAddresses.length < 1 ? (
          ...
          <React.Fragment>
            ...
            <Link to="/razorpay">
              <Button color="teal" size="massive">
                Pay with razorpay
              </Button>
            </Link>
          </React.Fragment>
...
const WrappedForm = () => (
  <Container text>
    <StripeProvider apiKey="pk_test_j7wRoK4EIGnTyQVJ9blz845J00jcFDPSaR">
      <div>
