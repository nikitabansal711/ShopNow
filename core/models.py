...
class Item(models.Model):
    ...
    liked_by = models.ManyToManyField(UserProfile, blank=True)
...
class OrderItem(models.Model):
    ...
    order_status = models.CharField(max_length=50, blank=True, null=True, default="Ordered")
...
class Order(models.Model):
    ...
    def all_items(self):
        itemlist = []
        for item_data in self.items.all():
            itemlist.append(item_data.get_all_items())
        return itemlist
